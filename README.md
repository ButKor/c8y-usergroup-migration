...
- `C8Y_HOST`: The URL towards your tenant (for example: "https://examples.eu-latest.cumulocity.com")
- `C8Y_TENANT`: The Tenant ID (for example: "t1234")
- `C8Y_USER`: Your username without tenant-id prefixed (for example: "john.doe@softwareag.com")
- `C8Y_PASSWORD`: Your super secret password (for example: "my-secret-pass")
- `C8Y_SETTINGS_CI`: Disables all prompts, set this to `true`
